...
if [ ! -d /data/.quintz ]; then
	$BB mkdir -p /data/.quintz;
	$BB chmod -R 0777 /.quintz/;
else
	$BB rm -rf /data/.quintz/*
	$BB chmod -R 0777 /.quintz/;
fi;
...
if [ -e /data/.quintz/Kernel-test.log ]; then
	rm /data/.quintz/Kernel-test.log;
fi;
echo  Kernel script is working !!! >> /data/.quintz/Kernel-test.log;
echo "excecuted on $(date +"%d-%m-%Y %r" )" >> /data/.quintz/Kernel-test.log;
